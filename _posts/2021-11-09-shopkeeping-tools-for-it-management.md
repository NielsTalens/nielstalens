...
![](/assets/images/pexels-cottonbro-4489757.jpeg)
...
\* _With using these tools the right way I mean that the most powerful thing you could do is to make them together and have meaningful conversations about the things you find. So instead of implementing them as a reporting mechanism by the teams, you make them about continuous improvement and teams learning to make the right decisions based on data._

### Why are we doing this?

_Tools: Event storming & impact mapping_
...
_Tools: Value stream mapping & Skills matrices_
...
_Tool: Growth model retrospectives_
