---
layout: post
title: "The importance of splitting teams (and how to)"
...
We have all seen them. Teams that seem to have no coherence and do not feel like a team. Instead of a team you see a group of people with different scopes or expertises that happen to be condemned to do the same meetings_._ Every day. More closely you could observe the following:

*   Daily standups where each team member mentions individual tasks,
...
![](/assets/images/pexels-nishant-aneja-2460874.jpeg)
...
> We should strive to build teams around a vision or purpose instead of trying to fit products in a team based on capacity.
...
Whenever a team is not responsible for creating products but are more supporting or guiding the organisation and/or their customers often a product vision makes less sense. In this case a team purpose could be more clear and concise.
...
![](/assets/images/team-split-template.jpeg)

### Based on types of work

The reality is that after an application's first release, the types of work and the way they come into the scope will change. Where before the release input can be controlled through stakeholder management, persona definitions and other enquiries the reality after going live is a different one. We now have new types of work like: operational, infrastructural, user feedback, bugs and customer implementations. Some of that work is product related, and we can manage through a proper DevOps setup, while others may conflict with the way product development is being done.

A specific example is customer implementations or projects for instance. The types of work in general are relatively simple implementation tasks and maybe some product related rfc's. In that cases the split of the team can be based on the type of work: either implementation or product. Both types of work have their own processes and management.

For example:

*   Implementation: small configurable tasks where no changes are needed in the product. Deadline driven.
*   Implementation or product: small changes that have some small impact on the product.
*   Product: changes that have impact on functionality. Roadmap driven.
...
Work is often either plannable or unplannable. Based on the organisational needs the right way of planning should be picked. Is unplannable work inevitable, a framework like Scrum might just not work since predictability is one of the main results we want from that. 

![](/assets/images/communication-lines.jpeg)
...
In my experience multidisciplinary teams of 3-5 people work best and with every extra team member the process and number of communication lines grows. It will take a quality drive approach in which DevOps, automation and testing are non negotiable since otherwise there is a need for additional roles. I personally will take a small team with a specific vision over any amount of resources and budget without clear objectives.